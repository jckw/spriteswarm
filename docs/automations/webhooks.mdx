...
Webhooks let external services trigger your automations when events happen—like a new PR, a Slack message, or a customer cancellation.
...
Events: `app_mention`, `message`, `reaction_added`, etc.
